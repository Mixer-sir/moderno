...
const menu: Record<string, Item[]> = {
  Завтраки: [
    ...
    {
      name: "Сырники",
      desc: "ванильная сметана, ягодный соус",
      price: "460",
      image:
        "https://images.unsplash.com/photo-1517094421773-0529f29ea451?q=80&w=1200&auto=format&fit=crop",
    },
  ],
  Закуски: [
    {
      name: "Тар-тар из лосося",
      desc: "кунжут, соус юдзу",
      price: "790",
      image:
    ...
    {
      name: "Хумус из нута",
      desc: "масло чили, лаваш",
      price: "520",
      tag: "vegan",
      image:
        "https://images.unsplash.com/photo-1604908812831-3994bc9b1b48?q=80&w=1200&auto=format&fit=crop",
    },
    {
      name: "Бурата",
      desc: "томаты, базилик, оливковое масло",
      price: "850",
      image:
        "https://images.unsplash.com/photo-1604908554023-59b7ab0d8f3b?q=80&w=1200&auto=format&fit=crop",
    },
  ],
  "Основные блюда": [
    {
      ...
      price: "980",
      image:
        "https://images.unsplash.com/photo-1544025164-5876e0a7a6ec?q=80&w=1200&auto=format&fit=crop",
    },
    {
  ...
  Десерты: [
    {
      ...
      desc: "солёная карамель",
      price: "520",
      image:
        "https://images.unsplash.com/photo-1541781286675-4a9b38a163b2?q=80&w=1200&auto=format&fit=crop",
    },
    {
    ...
    },
    {
      ...
      tag: "vegan",
      image:
        "https://images.unsplash.com/photo-1627662236979-8a0d1f2b8f6e?q=80&w=1200&auto=format&fit=crop",
    },
  ],
  Напитки: [
    {
    ...
    {
      name: "Эспрессо",
      desc: "одинарный/двойной",
      price: "190/240",
      image:
        "https://images.unsplash.com/photo-1507133750040-4a8f57021548?q=80&w=1200&auto=format&fit=crop",
    },
    {
      name: "Лимонад юдзу",
          ...
          >
            <div>
              <div className="flex items-center gap-2">
                <div className="text-base font-semibold group-hover:underline decoration-2 decoration-primary/60 underline-offset-4">
                  {i.name}
                </div>
                {i.tag && (
        ...
        <div className="container grid items-center gap-10 py-16 md:grid-cols-2 md:py-24">
          <div>
            <motion.div
              ...
              className="inline-flex items-center gap-2 rounded-full border border-border bg-background/70 px-3 py-1 text-xs uppercase tracking-wide text-muted-foreground backdrop-blur"
            >
              <span className="h-2 w-2 rounded-full bg-accent" /> Новое меню
              сезона
            </motion.div>
            <motion.h1
              ...
              className="mt-4 text-5xl font-extrabold leading-[1.05] tracking-tight md:text-6xl"
            >
            ...
            >
              Флэт‑эстетика, яркие акценты и честные продукты. Меню, где каждая
      ...
      <section className="border-y border-border/60 bg-accent">
        <div className="container flex flex-col items-center justify-between gap-6 py-10 text-accent-foreground md:flex-row">
          <div className="text-2xl font-extrabold">
            Сезонный сет‑меню — только в этом месяце
          </div>
          <Link
            to="/reserve"
